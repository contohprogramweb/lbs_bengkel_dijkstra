    ...
    <form method="POST" action="<?php echo site_url('admin/settings'); ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card card-dark-theme setting-card">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if($type === 'boolean'): ?>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input form-check-input-dark" type="checkbox" 
                                            ...
                                            <label class="form-check-label text-light" for="setting_<?php echo $setting->setting_key; ?>">
                                    ...
                                    <?php elseif($type === 'json'): ?>
                                        <textarea class="form-control form-control-dark font-monospace" 
                                                  name="settings[<?php echo $setting->setting_key; ?>]" 
                                                  rows="4"
