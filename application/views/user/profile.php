                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4 text-center">
                            <div class="position-relative d-inline-block">
                                <?php if ($user->avatar): ?>
                                    <img src="<?php echo base_url($user->avatar); ?>" alt="Avatar" class="rounded-circle shadow-sm" style="width: 180px; height: 180px; object-fit: cover;">
                                <?php else: ?>
                                    <div class="bg-primary rounded-circle d-inline-flex align-items-center justify-content-center text-white shadow-sm" style="width: 180px; height: 180px; font-size: 4rem;">
