        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <?php else: ?>
                        <a href="<?= site_url('workshop/create') ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="<?= site_url('workshop/services') ?>" class="btn btn-sm btn-outline-primary">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?= site_url('workshop/create') ?>" class="btn btn-primary">
