...
-- Dumping data for table dijkstrabengkelbaru.activity_logs: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.emergency_requests: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.invoices: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.report_settings: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.road_edges: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.road_nodes: ~0 rows (approximately)
...
-- Dumping data for table dijkstrabengkelbaru.system_settings: ~12 rows (approximately)
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'radius_darurat', '5', 'integer', 'Emergency radius in kilometers for emergency request matching', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(2, 'same_day_booking', '1', 'boolean', 'Enable/disable same-day booking feature', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(3, 'moderasi_review_ketat', '0', 'boolean', 'Enable strict review moderation', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(4, 'invoice_tax_rate', '11', 'float', 'Default tax rate percentage for invoices', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(5, 'invoice_due_days', '7', 'integer', 'Default due days for invoice payment', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(6, 'max_upload_size_mb', '5', 'integer', 'Maximum file upload size in MB', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(7, 'allowed_file_types', 'jpg,jpeg,png,pdf', 'string', 'Comma-separated allowed file extensions', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(8, 'featured_workshop_limit', '10', 'integer', 'Maximum number of featured workshops', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(9, 'reminder_interval_km', '5000', 'integer', 'Default kilometer interval for service reminder', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(10, 'reminder_interval_months', '6', 'integer', 'Default month interval for service reminder', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(11, 'reminder_max_per_week', '1', 'integer', 'Maximum reminders per week per vehicle', '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(12, 'booking_default_capacity', '5', 'integer', 'Default booking capacity per slot', '2026-06-07 19:22:34', '2026-06-07 19:22:34');
...
-- Dumping data for table dijkstrabengkelbaru.users: ~5 rows (approximately)
INSERT INTO `users` (`id`, `email`, `password`, `full_name`, `phone`, `role`, `avatar`, `is_active`, `is_deleted`, `deleted_at`, `email_verified_at`, `last_login_at`, `created_at`, `updated_at`) VALUES
	(1, 'admin@bengkel.com', '$2y$10$Z1RLuFUAqgRsqfgMWpir7.QgYmvic8XDM7pvG.FmDgpAzbUreBqJq', 'Administrator', '081234567890', 'admin', NULL, 1, 0, NULL, '2026-06-07 19:22:34', '2026-06-07 13:13:25', '2026-06-07 19:22:34', '2026-06-07 20:13:25'),
	(2, 'owner1@bengkel.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Budi Santoso', '081234567891', 'workshop_owner', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(3, 'owner2@bengkel.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Siti Aminah', '081234567892', 'workshop_owner', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(4, 'mechanic1@bengkel.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Ahmad Hidayat', '081234567893', 'mechanic', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(5, 'mechanic2@bengkel.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Rudi Hartono', '081234567894', 'mechanic', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(6, 'customer1@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Andi Wijaya', '081234567895', 'customer', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(7, 'customer2@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Dewi Lestari', '081234567896', 'customer', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(8, 'customer3@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Eko Prasetyo', '081234567897', 'customer', NULL, 1, 0, NULL, '2026-06-07 19:22:34', NULL, '2026-06-07 19:22:34', '2026-06-07 19:22:34'),
	(9, 'dedhy2001@yahoo.com', '$2y$10$Z1RLuFUAqgRsqfgMWpir7.QgYmvic8XDM7pvG.FmDgpAzbUreBqJq', 'dedhy', '-', 'customer', NULL, 1, 0, NULL, NULL, NULL, '2026-06-07 19:31:31', '2026-06-07 19:31:31');
...
INSERT INTO `workshops` (`id`, `user_id`, `name`, `description`, `address`, `city`, `province`, `postal_code`, `latitude`, `longitude`, `phone`, `whatsapp`, `logo`, `photos`, `rating_avg`, `total_reviews`, `status`, `is_featured`, `verified_at`, `business_license`, `certification_doc`, `is_active`, `is_deleted`, `deleted_at`, `approved_by`, `approved_at`, `rejection_reason`, `operating_hours`, `services_offered`, `created_at`, `updated_at`) VALUES
	(1, 2, 'Bengkel Maju Jaya', 'Spesialis servis mobil Jepang dan Eropa', 'Jl. Raya Bogor No. 123', 'Jakarta Timur', 'DKI Jakarta', '13460', -6.22974600, 106.82291700, '021-12345678', '081234567891', NULL, NULL, 4.50, 2, 'active', 1, '2026-06-07 19:22:35', NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-06-07 19:22:35', '2026-06-07 19:22:35'),
	(2, 3, 'Bengkel Berkah Motor', 'Servis motor dan mobil semua merk', 'Jl. Sudirman No. 45', 'Bandung', 'Jawa Barat', '40123', -6.91746400, 107.61912300, '022-87654321', '081234567892', NULL, NULL, 0.00, 0, 'active', 0, '2026-06-07 19:22:35', NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-06-07 19:22:35', '2026-06-07 19:22:35');
